# Collaborators — procurement-automation
...
- **Eukrit Seang** <eukrit@goco.bz>
  ...
  - GitHub: Owner of `eukrit/procurement-automation`
...
- **Scope:**
  ...
  - **GitHub:** Write on `eukrit/procurement-automation` (branch protection on `main` gates all merges)
