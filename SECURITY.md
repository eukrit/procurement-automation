...
### 3. GitHub
- [ ] Branch protection on `main`: applied via `apply-branch-protection.sh eukrit/procurement-automation`
...
- [ ] Remove GitHub collaborator: `gh api -X DELETE repos/eukrit/procurement-automation/collaborators/[username]`
